...
const Header = () => {
    ...
    return (
    <div className="flex flex-col items-center justify-center space-y-4 text-center mt-20 px-4 text-gray-800">
      <img
      ...
      <p className="mb-8 max-w-md">
        This is a simple app that demonstrates user authentication using JWT and
        OAuth2.0
      </p>
